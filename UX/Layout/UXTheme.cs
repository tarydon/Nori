...
static class UXTheme {
   ...
   public static (int H, int V) MENUBAR_Padding = (8, 6);
   ...
   public static (int L, int T, int R, int B) MENUITEM_Padding = (20, 7, 20, 6);
   ...
   public static int POPUPMENU_Padding = 10;
   ...
   public static (int H, int V) DIALOG_TitlePadding = (15, 10);
   ...
   public static int DIALOG_Padding = 20;
   ...
   public static (int H, int V) BUTTON_Padding = (14, 7);
