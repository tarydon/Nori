...
public static class Extensions {
   ...
   public static double Along (this double f, double a, double b)
      => a + (b - a) * f;
   /// <summary>
   /// Interpolates using a given lie f between two floats a and b
   /// </summary>
   public static float Along (this float f, float a, float b)
      => a + (b - a) * f;
   ...
   /// <summary>
   /// Interpolates using a given lie between two Point3f a and b
   /// </summary>
   ...
   /// <summary>
   /// Rounds a float to be a multiple of the given least-count
   /// </summary>
