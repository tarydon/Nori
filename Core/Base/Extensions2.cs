...
public static class Extensions2 {
   ...
   extension(ReadOnlySpan<byte> s) {
      ...
      /// <summary>Converts a ReadOnlySpan(byte) to a float, returning 0 if the conversion fails</summary>
      public float ToFloat () => Utf8Parser.TryParse (Trim (s), out float f, out _) ? f : 0;
      /// <summary>Converts a ReadOnlySpan(byte) to a float, returning the fallback value if the converstion fails</summary>
