...
public class AList<T> : IReadOnlyList<T>, IList<T>, IAList {
   ...
   /// <summary>
   /// Copies the contents of this AList into the given array, starting at the given index
   /// </summary>
   ...
   /// <summary>
   /// Creates an enumerator that can be used to walk through the elements in the AList
   /// </summary>
