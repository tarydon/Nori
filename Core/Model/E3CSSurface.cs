...
public sealed class E3Cylinder : E3CSSurface {
   ...
   /// <summary>
   /// Optimized Cylinder build - rotates the CS if needed about Z to align the trim line correctly
   /// </summary>
...
public sealed class E3SpunSurface : E3CSSurface {
   ...
   // Properties ---------------------------------------------------------------
   /// <summary>
   /// The generatrix curve in canonical space
   /// </summary>
...
public sealed class E3Torus : E3CSSurface {
   ...
   protected override Bound2 ComputeDomain () => new (0, 0, Lib.TwoPI, Lib.TwoPI);
}
#endregion
