...
public sealed class E3Cone : E3CSSurface {
   // Constructors -------------------------------------------------------------
   /// <summary>Construct a Cone, given a target CoordSystem and the tip Half-angle</summary>
...
public sealed class E3Cylinder : E3CSSurface {
   // Constructors -------------------------------------------------------------
   /// <summary>Construct a Cylinder, given the target CoordSystem and the Radius</summary>
...
public sealed class E3Plane : E3CSSurface {
   ...
   protected override Mesh3 BuildMesh (double tol, double angTol) {
      ...
      tess.Tolerance = ETolerance.VeryCoarse;
...
public sealed class E3Sphere : E3CSSurface {
   // Constructors -------------------------------------------------------------
   /// <summary>Construct a Sphere, given the target CoordSystem and the Radius</summary>
...
public sealed class E3SpunSurface : E3CSSurface {
   // Constructors -------------------------------------------------------------
   /// <summary>Construct a SpunSurface, given the target CoordSystem and the Generatrix</summary>
...
public sealed class E3SweptSurface : E3CSSurface {
   // Constructors -------------------------------------------------------------
   /// <summary>Construct a SweptSurface, given the target CoordSystem and the Generatrix</summary>
...
public sealed class E3Torus : E3CSSurface {
   // Constructors -------------------------------------------------------------
   /// <summary>Construct a Torus, given the target CoordSystem, and the minor and major radii</summary>
