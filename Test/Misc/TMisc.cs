...
class TMisc {
   ...
   void Test7 () {
      ...
      a.Is (2); b.Is (3);
      Lib.ReadText ("nwad:GL/Shader/arrowhead.frag").Length.Is (240);
      Lib.ReadBytes ("nwad:GL/Shader/arrowhead.frag").Length.Is (251);
      Lib.ReadLines ("nwad:GL/Shader/arrowhead.frag").Length.Is (12);
