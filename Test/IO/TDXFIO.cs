...
[Fixture (1, "Basic DXF Tests", "DXF")]
class DXFTests {
   [Test (1, "Basic DXF load test")]
   void Test1 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Basic.dxf"));
      dwg.Ents.Count.Is (57);
   }

   [Test (2, "DXF round-trip test")]
   void Test2 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Basic.dxf"));
      DXFWriter.SaveFile (dwg.Purge (), NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/Basic.dxf"), NT.TmpDXF);
   }

   [Test (3, "DXF round-trip test for point")]
   void Test3 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Point.dxf"));
      DXFWriter.SaveFile (dwg.Purge (), NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/Point.dxf"), NT.TmpDXF);
   }

   [Test (4, "DXF Reader test for POLYLINE entity")]
   void Test4 () {
   ...
   [Test (5, "DXF round-trip test for ellipse")]
   void Test5 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Ellipse.dxf"));
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/Ellipse.dxf"), NT.TmpDXF);
   }

   [Test (6, "DXF Writer test for POLYLINE entity")]
   void Test6 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Poly.dxf"));
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/Poly.dxf"), NT.TmpDXF);
   }

   [Test (7, "DXF round-trip test for TEXT")]
   void Test7 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Text.dxf"));
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/Text.dxf"), NT.TmpDXF);
   }

   [Test (8, "DXF color to Pix color conversion test")]
   void Test8 () {
   ...
   [Test (9, "DXF Reader test for LWPOLYLINE entity")]
   void Test9 () {
   ...
   [Test (10, "DXF test for MTEXT")]
   void Test10 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/MText.dxf"));
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/MText.dxf"), NT.TmpDXF);
   }

   [Test (11, "Issue.36 POLYLINE entity is not rendered correctly")]
   void Test11 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/PolyErr.dxf"));
      dwg.Purge ();
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/PolyErr.dxf"), NT.TmpDXF);
   }

   [Test (12, "DXF round-trip test for layers")]
   void Test12 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Layers.dxf"));
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/Layers.dxf"), NT.TmpDXF);
   }

   [Test (13, "Pix color to DXF Color conversion test")]
   void Test13 () {
      // Standard values
   ...
   [Test (14, "Test for converting encoded texts to special characters")]
   void Test14 () {
   ...
   [Test (15, "Font selection doesn't seem to work for the attached MTEXT file")]
   void Test15 () {
      ...
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/3Horns.txt"), tmp);
   }

   [Test (16, "DXF round-trip test for solid")]
   void Test16 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Solid.dxf"));
      dwg.Purge ();
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/Solid.dxf"), NT.TmpDXF);
   }

   [Test (20, "Color selection based on their priority ")]
   void Test17 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Color1.dxf"));
      DXFWriter.SaveFile (dwg.Purge (), NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/Color1.dxf"), NT.TmpDXF);
   }

   [Test (21, "DXF round-trip test for INSERT")]
   void Test18 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/Block01.dxf"));
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/Block01.dxf"), NT.TmpDXF);
   }

   [Test (23, "Pix crashes when trying to import the attached DXF files")]
   void Test19 () {
      ...
      foreach (var name in files) {
         ...
         DXFWriter.SaveFile (dwg.Purge (), NT.TmpDXF);
         Assert.TextFilesEqual (NT.File ($"IO/DXF/Out/{name}.dxf"), NT.TmpDXF);
      }
   }

   [Test (58, "Text alignment flags")]
   void Test20 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/TextAlign.dxf"));
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/TextAlign.dxf"), NT.TmpDXF);
   }
}

[Fixture (5, "Next set of DXF tests", "DXF")]
class DXFTests2 {
   [Test (65, "Reading ATTRIB entities")]
   void Test1 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/D00537.dxf"));
      CurlWriter.ToFile (dwg.Purge (), NT.TmpCurl);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/D00537.curl"), NT.TmpCurl);
   }

   [Test (66, "Reading attributes of MTEXT")]
   void Test2 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/D01273.dxf"));
      CurlWriter.ToFile (dwg.Purge (), NT.TmpCurl);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/D01273.curl"), NT.TmpCurl);
      DXFWriter.SaveFile (dwg, NT.TmpDXF);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/D01273.dxf"), NT.TmpDXF);
   }

   [Test (68, "Test for Codepage 1252")]
   void Test3 () {
      var dwg = DXFReader.FromFile (NT.File ("IO/DXF/D58839.dxf"));
      CurlWriter.ToFile (dwg.Purge (), NT.TmpCurl);
      Assert.TextFilesEqual (NT.File ("IO/DXF/Out/D58839.curl"), NT.TmpCurl);
   }

   // TODO: Move this to Nori.Test once we move DxfReader there
   [Test (69, "Test for ShapeRecognizer")]
   void Test4 () {
      List<string> shapes = [];
      ...
      Assert.TextFilesEqual (NT.File ("IO/DXF/Shapes1.txt"), NT.TmpTxt);
   }
}