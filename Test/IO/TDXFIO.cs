...
class DXFTests {
   ...
   void Test2 () {
      ...
      Assert.TextFilesEqual ("IO/DXF/Out/Basic.dxf", NT.TmpDXF);
   }
   ...
   void Test3 () {
      ...
      DXFWriter.Save (dwg.Purge (), NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/Point.dxf", NT.TmpDXF);
   }
   ...
   void Test5 () {
      ...
      Assert.TextFilesEqual ("IO/DXF/Out/Ellipse.dxf", NT.TmpDXF);
   }
   ...
   void Test6 () {
      var dwg = DXFReader.Load (NT.File ("IO/DXF/Poly.dxf"));
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/Poly.dxf", NT.TmpDXF);
   }
   ...
   void Test7 () {
      ...
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/Text.dxf", NT.TmpDXF);
   }
   ...
   void Test10 () {
      ...
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/MText.dxf", NT.TmpDXF);
   }
   ...
   void Test11 () {
      ...
      dwg.Purge ();
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/PolyErr.dxf", NT.TmpDXF);
   }
   ...
   void Test12 () {
      ...
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/Layers.dxf", NT.TmpDXF);
   }
   ...
   void Test15 () {
      ...
      Assert.TextFilesEqual ("IO/DXF/Out/3Horns.txt", tmp);
   }
   ...
   void Test16 () {
      ...
      dwg.Purge ();
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/Solid.dxf", NT.TmpDXF);
   }
   ...
   void Test17 () {
      ...
      DXFWriter.Save (dwg.Purge (), NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/Color1.dxf", NT.TmpDXF);
   }
   ...
   void Test18 () {
      ...
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/Block01.dxf", NT.TmpDXF);
   }
   ...
   void Test19 () {
      ...
      foreach (var name in files) {
         ...
         DXFWriter.Save (dwg.Purge (), NT.TmpDXF);
         Assert.TextFilesEqual ($"IO/DXF/Out/{name}.dxf", NT.TmpDXF);
      }
   }
   ...
   void Test20 () {
      ...
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/TextAlign.dxf", NT.TmpDXF);
   }
   ...
   public void Test21 () {
      ...
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/BendLine.dxf", NT.TmpDXF);
   }
}
...
class DXFTests2 {
   ...
   void Test1 () {
      ...
      CurlWriter.Save (dwg.Purge (), NT.TmpCurl);
      Assert.TextFilesEqual ("IO/DXF/Out/D00537.curl", NT.TmpCurl);
   }
   ...
   void Test2 () {
      ...
      CurlWriter.Save (dwg.Purge (), NT.TmpCurl);
      Assert.TextFilesEqual ("IO/DXF/Out/D01273.curl", NT.TmpCurl);
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/D01273.dxf", NT.TmpDXF);
   }
   ...
   void Test3 () {
      ...
      CurlWriter.Save (dwg.Purge (), NT.TmpCurl);
      Assert.TextFilesEqual ("IO/DXF/Out/D58839.curl", NT.TmpCurl);
   }
   ...
   void Test5 () {
      ...
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/Layer.dxf", NT.TmpDXF);
   }
   ...
   void Test6 () {
      ...
      Assert.TextFilesEqual ("IO/DXF/Out/Bend-10.curl", NT.TmpCurl);
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/Bend-10.dxf", NT.TmpDXF);
   }
   ...
   void Test7 () {
      ...
      CurlWriter.Save (dwg, NT.TmpCurl);
      Assert.TextFilesEqual ("IO/DXF/Out/BasicBend.curl", NT.TmpCurl);
   }
   ...
   void Test8 () {
      ...
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/BendSeg.dxf", NT.TmpDXF);
   }
   ...
   void Test9 () {
      ...
      CurlWriter.Save (dwg, NT.TmpCurl);
      Assert.TextFilesEqual ("IO/DXF/Out/D17616.curl", NT.TmpCurl);
      dwg = DXFReader.Load (NT.File ("IO/DXF/D17666.dxf"));
      CurlWriter.Save (dwg, NT.TmpCurl);
      Assert.TextFilesEqual ("IO/DXF/Out/D17666.curl", NT.TmpCurl);
   }
   ...
   void Test10 () {
      ...
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/D17666.dxf", NT.TmpDXF);
      dwg = DXFReader.Load (NT.File ("IO/DXF/D17292.dxf"));
      DXFWriter.Save (dwg, NT.TmpDXF);
      Assert.TextFilesEqual ("IO/DXF/Out/D17292.dxf", NT.TmpDXF);
   }
   ...
   [Test (133, "Dimension loaded before corresponding Block")] // Skipping: INCH issue. Even though it appears to behave similar to Flux!
   void Test13 () {
      var dwg = DXFReader.Load (NT.File ("IO/DXF/WC-RL2B-2502.dxf"));
      CurlWriter.Save (dwg, NT.TmpCurl);
      Assert.TextFilesEqual ("IO/DXF/Out/WL-RL2B-2502.curl", NT.TmpCurl);
   }
}
