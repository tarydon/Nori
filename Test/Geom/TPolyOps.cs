...
class PolyEdgeTests {
   ...
   void Test2 () {
      ...
      Poly? poly;
      poly = rect.EdgeNotch (0, left: true, 10, 10, 10, 2); poly!.Is ("M0,0H5V8Q7,10,-1H13Q15,8,-1V0H60V50H0Z");
      poly = rect.EdgeNotch (0, left: false, 10, 10, 10, 2); poly!.Is ("M0,0H5V-8Q7,-10,1H13Q15,-8,1V0H60V50H0Z");

      Poly line = Poly.Line (0, 0, 50, 0);
      poly = line.EdgeNotch (0, left: true, 5, 10, 10, 2); poly!.Is ("M0,0V8Q2,10,-1H8Q10,8,-1V0H50");
      poly = line.EdgeNotch (0, left: false, 5, 10, 10, 2); poly!.Is ("M0,0V-8Q2,-10,1H8Q10,-8,1V0H50");
   }
}